...
namespace glfw
{
  ...
  void Viewer::Create_bounding_box()
  {
          ...
          trees.at(selected_data_index) = new igl::AABB<Eigen::MatrixXd, 3>();
          trees.at(selected_data_index)->init(data().V, data().F); 
          treeSize++;
          
         
          Eigen::AlignedBox <double, 3> box = trees.at(selected_data_index)->m_box;
